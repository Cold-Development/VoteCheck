...
public abstract class CommandHandler implements TabExecutor, NamedExecutor {
     ...
     */
    protected final Map<String, dev.padrewin.votechecker.commands.BaseCommand> registeredCommands = new HashMap<>();
    /**
     ...
     */
    public CommandHandler(VoteChecker plugin, String cmd, CommandManager.CommandAliases aliases) {
        this.plugin = plugin;
        this.cmd = cmd;
     ...
     */
    public void registerCommand(dev.padrewin.votechecker.commands.BaseCommand command) {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        dev.padrewin.votechecker.commands.BaseCommand subCommand = this.registeredCommands.get(subcmd);
        if (subCommand == null) {
        ...
        try {
            ...
            sender.sendMessage(ChatColor.RED + "A VoteChecker error occurred while executing that command. Did you enter an invalid parameter?");
        }
