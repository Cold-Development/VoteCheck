...
public class VersionCommand extends dev.padrewin.votechecker.commands.BaseCommand {
    ...
    public static void sendInfo(VoteChecker plugin, CommandSender sender) {
        ...
        localeManager.sendCustomMessage(sender, baseColor + "Running <g:#635AA7:#E6D4F8:#9E48F6>VoteChecker" + baseColor + " v" + plugin.getDescription().getVersion());
        ...
        if (sender instanceof Player) {
            ...
            clickableText.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://github.com/Cold-Development/VoteChecker"));
            ...
            sender.sendMessage(ansiAqua + "GitHub: " + ansiRed + "https://github.com/Cold-Development/VoteChecker" + ansiReset);
        }
