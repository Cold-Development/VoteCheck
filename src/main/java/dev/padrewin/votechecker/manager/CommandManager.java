...
import dev.padrewin.votechecker.commands.Commander;
...
public class CommandManager extends Manager {
    ...
    public void reload() {
        ...
        // Register commands
        Commander commander = new Commander((VoteChecker) this.coldPlugin);
        PluginCommand command = this.coldPlugin.getCommand("votechecker");
        if (command != null)
